...
public class DBHandler {
    private static final String url = "jdbc:mysql://localhost:3306/orders?serverTimezone=Europe/Moscow&useSSL=false";
    private static final String login = "root";
    private static final String pass = "Karovabogoskach21";
