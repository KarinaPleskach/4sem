...
public class ReadEmail {
    public static final String USERNAME = "Карина Плескач";
    public static final String PASSWORD = "karovabogoskach21";
    ...
    public static void main(String[] args) throws Exception {
        ...
        props.put("mail.pop3.host", "karinapleskach@mail.ru");
        ...
        store.connect("karinapleskach@mail.ru", ReadEmail.USERNAME, ReadEmail.PASSWORD);
